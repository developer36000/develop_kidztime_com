	...
	<div id="payment">
		<?php if ( $order->needs_payment() ) : ?>
			<?php if( ! empty( $available_gateways ) ) : ?>
			     ...
			     <div class="payment_methods--box">
				     <?php 	foreach ( $available_gateways as $gateway ) {
					     wc_get_template( 'checkout/payment-method-box.php', array( 'gateway' => $gateway ) );
				     } ?>
			     </div>
			<?php else : ?>
				<p class="woocommerce-notice woocommerce-notice--info woocommerce-info"><?php apply_filters( 'woocommerce_no_available_payment_methods_message', esc_html__( 'Sorry, it seems that there are no available payment methods for your location. Please contact us if you require assistance or wish to make alternate arrangements.', 'woocommerce' ) ) ?></p>
			<?php endif; ?>
